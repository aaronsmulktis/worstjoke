...
if( !function_exists("wp_bootstrap_theme_styles") ) {  
    function wp_bootstrap_theme_styles() { 
        ...
        wp_register_style( 'wpbs', get_template_directory_uri() . '/library/dist/css/styles.b718b26b.min.css', array(), '1.0', 'all' );
...
if( !function_exists( "wp_bootstrap_theme_js" ) ) {  
  function wp_bootstrap_theme_js(){
    ...
    wp_register_script( 'wpbs-js', 
      get_template_directory_uri() . '/library/dist/js/scripts.fb94eaa3.min.js',
      array('bootstrap'), 
      '1.2' );
...
function new_royalslider_add_custom_skin($skins) {
      $skins['rsRed'] = array(
           'label' => 'Red Controls',
           'path' => get_stylesheet_directory_uri() . '/rs-red/rs-red.css'  // get_stylesheet_directory_uri returns path to your theme folder
      );
      return $skins;
}
